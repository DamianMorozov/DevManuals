...
## [0.4.030] - 2025-08-19
### Added
- Windows/Updates/Remove-and-hide-KBs.ps1
### Changed
...
## [0.4.013] - 2024-07-12
### Changed
- [Dev/Windows SDK](Dev/Windows%20SDK.md)
...
- [Dev/CSharp/CSharp troubleshooting](Dev/CSharp/CSharp%20troubleshooting.md)
...
### Added
- [Windows/Security/Audit](Windows/Security/Audit.md)
...
- [Dev/ML/ChatGPT/ChatGPT resources](Dev/ML/ChatGPT/ChatGPT%20resources.md)
- [Dev/ML/GitHub/GitHub SSH keys](Dev/GitHub/GitHub%20SSH%20keys.md)
...
## [0.3.640] - 2023-01-13
### Added
- [Dev/ChatGPT](Dev/ChatGPT/README.md)
- [Dev/ChatGPT/Resources](Dev/ChatGPT/Resources.md)
...
- [Dev/Visual Studio/VS 2019 default keyboard shortcuts](Dev/Visual%20Studio/VS%202019%20default%20keyboard%20shortcuts.png)
...
- [Dev/Visual Studio/VS options](Dev/Visual%20Studio/README.md)
...
- Dev/HTML/README.md
- Dev/HTML/HTML Encoding Reference.md
...
## [0.2.210] - 2021-12-13
### Added
- Programs developing/C#/IDisposable.md
...
## [0.2.192] - 2021-10-26
### Changed
- Dev/GUI/Uno platform resources.md
...
- Dev/Markdown.md
- Dev/Markdown-cheat-sheet.md
### Added
- Dev/Diagrams/Diagrams resources in English.md
- Dev/GUI/WPF resources in Russian.md
- Dev/GUI/WinUI resources in English.md

## [0.2.178] - 2021-09-03
### Added
- Dev/C# Blazor/Resources.txt

## [0.2.177] - 2021-09-02
### Added
- Dev/MS Visual Studio/Project properties.txt
...
## [0.2.173] - 2021-08-24
### Added
- Dev/MS Visual Studio/Tips and trics.txt

## [0.2.172] - 2021-08-20
### Added
- Dev/Uno platform/Uno resources.txt
...
## [0.2.160] - 2021-06-22
### Added
- Dev/MS Visual Studio/Downloads.txt
...
## [0.2.156] - 2021-03-26
### Added
- Dev/MS Visual Studio/Continuous Integration Transformation.txt
...
## [0.2.146] - 2021-01-08
### Changed
- Dev/Network/Telegram resources.txt
...
## [0.2.126] - 2020-12-17
### Changed
- Dev/Design patterns/Design patterns.txt-ru
### Added
- Dev/Design patterns/Design patterns resources.txt
...
## [0.2.114] - 2020-12-05
### Changed
- Dev/Virtual machine/Hyper-V ACL.txt
- Dev/Virtual machine/Hyper-V NAT.txt
...
## [0.2.107] - 2020-11-20
### Added
- Dev/C# Blazor/Blazor github.txt
### Changed
- Dev/C# Blazor/Resources.txt
...
## [0.2.100] - 2020-11-10
### Added
- Dev/Virtual machine/Virtual HDD.txt
- Dev/Virtual machine/Hyper-V NAT.txt
### Changed
- Dev/C# Blazor/2019. Blazor Revealed. Building Web Applications in .NET.txt
- Dev/C# Blazor/Use ASP.NET Core SignalR with Blazor WebAssembly.txt

## [0.2.96] - 2020-11-09
### Added
- Dev/C# Blazor/ASP.NET Core Blazor hosting models.txt
- Dev/C# Blazor/Blazor - Build client web apps with C#.txt
- Dev/C# Blazor/Resources.txt
- Dev/C# Blazor/Resources.txt-ru
### Changed
...
## [0.2.85] - 2020-11-06
### Added
- Dev/2019. Blazor Revealed. Building Web Applications in .NET.txt
- Dev/2020. Blazor for ASP.NET Web Forms Developers.txt
...
## [0.2.78] - 2020-10-21
### Added
- Dev/MS Visual Studio/Default code snippets.txt
### Changed
- Windows/PowerShell/gwmi.txt

## [0.2.76] - 2020-10-14
### Added
- Dev/Nuget/Nuget CLI.txt
...
## [0.2.72] - 2020-10-06
### Added
- Dev/2019. Concurrency in C# Cookbook.txt-ru
...
## [0.2.67] - 2020-08-12
### Added
- Dev/XAML/Fluent Design.txt

## [0.2.66] - 2020-08-07
### Changed
- Dev/MS Visual Studio/Extensions.txt
...
## [0.2.51] - 2020-06-02
### Changed
- Dev/MS Visual Studio/Attributes.txt-ru
...
## [0.2.48] - 2020-04-07
### Added
- Dev/C#/Count of digits.txt

## [0.2.47] - 2020-04-02
### Changed
- Dev/C#/Access modifiers.txt-ru
- Dev/MS Visual Studio/Attributes.txt-ru
- Dev/XAML/2018. WPF Development Cookbook.txt
### Added
- Dev/C#/Access modifiers.png
...
## [0.2.37] - 2020-02-20
### Changed
- Dev/XAML/2013. Building Windows 8 Apps with C# and XAML.txt-ru
- Dev/XAML/2018. WPF Development Cookbook.txt
...
- Dev/XAML/2013. Building Windows 8 Apps with C# and XAML.txt-ru
### Changed
- Dev/C#/2018. XAML.txt-ru -> XAML/2018. XAML.txt-ru

## [0.2.28] - 2020-01-23
### Updated
- Dev/Dev app creating manual.txt
- Dev/C#/6 lesser-known features of C# .NET that you should be using.txt

## [0.2.26] - 2020-01-22
### Added
- Dev/C#/6 lesser-known features of C# .NET that you should be using.txt
### Changed
- Dev/C#/2016. Библия C#.txt -> 2016. Bible C #.txt-ru
- Dev/C#/2018. C# 7 Карманный справочник.txt -> 2018. C# 7 Pocket guide.txt-ru
- Dev/C#/2018. C# и платформы .NET и .NET Core.txt -> 2018. C # and the .NET and .NET Core.txt-ru
- Dev/C#/2018. XAML.txt -> 2018. XAML.txt-ru
- Dev/C#/Access modifiers.txt -> Access modifiers.txt-ru
- Dev/C#/C# code style.txt -> C# code style.txt-ru
- Dev/C#/C# X what news.txt -> C# X what news.txt-ru
- Dev/C#/Exceptions.txt -> Exceptions.txt-ru
- Dev/C#/Interface.txt -> Interface.txt-ru
- Dev/C#/Stopwatch.txt -> Stopwatch.txt-ru
- Dev/C#/WPF metanit.txt -> WPF metanit.txt-ru
- Dev/C#/WPF professorweb.txt - WPF professorweb.txt-ru
### Updated
- Dev/C#/6 lesser-known features of C# .NET that you should be using.txt
- Dev/C#/AsyncCallback.txt
- Dev/C#/Foreach enum ProcessWindowStyle.txt
- Dev/C#/Performance.txt
- Dev/C#/WPF XAML Enum.txt

## [0.2.06] - 2020-01-20
### Updated
- Dev/Dev app creating manual.txt
### Changed
- Dev/Design patterns.txt -> Design patterns.txt-ru

## [0.2.04] - 2020-01-17
### Updated and renamed
- Dev/2019. Clean architecture.txt-ru
...
## [0.1.94] - 2019-11-25
### Added
- Dev/MS Visual Studio/XAML Features in VS 2019 16.4 preview 3.txt
...
- Dev/C#/Arrays.txt
### Changed
- Dev/C#/Data types.txt -> Data types.txt-ru
...
## [0.1.87] - 2019-09-17
### Updated
- Dev/2006. Say it with charts complete toolkit.txt-ru
- Dev/2016. Grokking Algorithms.txt-ru
...
- Dev/2016. Grokking Algorithms.txt-ru
### Changed
- Dev/MS Visual Studio/Hotkeys Visual Studio.txt
...
## [0.1.40] - 2019-07-31
### Updated
- Dev/MS Visual Studio/Options.txt
...
## [0.1.34] - 2019-07-18
### Added
- Dev/Nuget/MSTest.TestAdapter.txt
- Dev/Developer rules.txt
### Updated
- [README](README.md)
- Dev/Developer rules.txt-ru
- Dev/2014. The Art of Unit Testing (with examples in C#).txt-ru
- Dev/2017. Building Maintainable Software (C# Edition).txt-ru
- Dev/2019. Clean architecture.txt-ru
...
## [0.1.26] - 2019-06-28
### Added
- Dev/SQL/Error Невозможно привести Com-объект типа System.__ComObject.txt
- Dev/SQL/MS SQL versions.txt
- Dev/SQL/Язык запросов SQL.txt
### Updated
...
## [0.1.18] - 2019-05-31
### Added
- Dev/MS Visual Studio/PVS-Studio.txt
...
### Added
- Dev/SQL/Cursor.txt
- Dev/SQL/Data types.txt
- Dev/SQL/MS SQL 2005. Библия пользователя.txt
- Dev/SQL/Setup versions.txt
- Windows/PID.txt
### Updated
- Dev/Git.txt
- Dev/Правила разработчика.txt

## [0.1.05] - 2019-05-13
### Added
- Dev/Правила разработки.txt

## [0.1.04] - 2019-04-30
### Added
- Dev/C#/Plugins.txt
- Dev/MS Excel/Excel constants.txt
- Dev/MS Excel/Excel options.txt
- Dev/MS VB/Last cell.txt
- Dev/SQL/ConnectionString.txt
- Dev/SQL/DateTime.txt
- Dev/SQL/Help.txt
- Dev/2014. Искусство автономного тестирования.txt
- Dev/Design patterns.txt
...
## [0.0.86] - 2019-04-17
### Added
- Dev/C#/2016. Библия C#.txt
- Dev/C#/2018. C# и платформы .NET и .NET Core.txt
- Dev/C#/2018. XAML.txt
- Dev/C#/C# 2 what news.txt
- Dev/C#/C# 3 what news.txt
- Dev/C#/C# 4 what news.txt
- Dev/C#/C# 5 what news.txt
- Dev/C#/C# 6 what news.txt
- Dev/C#/C# 7 what news.txt
- Dev/C#/C# code style.txt
- Dev/C#/Exceptions.txt
- Dev/C#/Interface.txt
- Dev/C#/Performance.txt
- Dev/C#/SemaphoreSlim.txt
- Dev/C#/WPF Access controls from threads.txt
- Dev/C#/WPF metanit.txt
- Dev/C#/WPF professorweb.txt
- Dev/C#/WPF XAML Enum.txt
- Dev/MS Visual Studio/Toolbox reset.txt
...
## [0.0.70] - 2019-04-15
### Updated
- Dev/2019. Чистая архитектура.txt
...
## [0.0.66] - 2019-04-09
### Added
- Dev/MS Visual Studio/Attributes.txt
- Dev/MS Visual Studio/Debug.txt
- Dev/MS Visual Studio/Debug VBScript.txt
- Dev/MS Visual Studio/DevExpress.txt
- Dev/MS Visual Studio/Entity Framework.txt
- Dev/MS Visual Studio/Garbage Collector.txt
- Dev/MS Visual Studio/Hotkeys ReSharper.txt
- Dev/MS Visual Studio/Hotkeys Visual Studio.txt
- Dev/MS Visual Studio/Options.txt
- Dev/MS Visual Studio/Options 2019.txt
### Changed
- Android -> Dev/Android
...
## [0.0.52] - 2019-04-05
### Added
- Dev/C#/2018. C# 7. Карманный справочник.txt
- Dev/C#/C# versions.txt
- Dev/C#/Data types.txt
- Dev/C#/Foreach enum.txt
- Dev/C#/Stopwatch.txt
- Dev/Nuget/Ninject.txt
- Dev/Nuget/NUnit.txt
...
- Windows/Settings/Mklink.txt
- Windows/Settings/netsh interface portproxy.txt
...
- Dev/Entity Component System.txt
- Dev/Principles of OOP.txt
- Dev/SOLID.txt
- [Linux](Linux/README.md)
