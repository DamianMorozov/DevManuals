...
- [NuGet Package](https://www.nuget.org/packages/RestSharp "nuget.org")
...
- [NuGet Package](https://www.nuget.org/packages/Newtonsoft.Json/ "nuget.org")

## Serilog - simple .NET logging with fully-structured events
- [NuGet Package](https://www.nuget.org/packages/Serilog/ "nuget.org")

## NUnit - features a fluent assert syntax, parameterized, generic and theory tests and is user-extensible.
- [NuGet Package](https://www.nuget.org/packages/NUnit/ "nuget.org")
...
- [NuGet Package](https://www.nuget.org/packages/NodaTime/ "nuget.org")

## FluentEmail - send emails very easily
- [NuGet Package](https://www.nuget.org/packages/FluentEmail.Core/ "nuget.org")

## Hangfire - create, process, and manage background work
- [NuGet Package](https://www.nuget.org/packages/Hangfire/ "nuget.org")
...
- [NuGet Package](https://www.nuget.org/packages/LazyCache/ "nuget.org")
