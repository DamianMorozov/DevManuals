...
git show v0.0.000                                 ## просмотр содержимого тега
git tag                                           ## просмотр тегов
git tag -a v0.0.000 -m "TASK-xxx"                 ## создать тег с версией и комментарием
git tag -a v0.0.000 0011223344                    ## создать тег с версией для коммита по части хэша
git tag -d v0.0.000                               ## удалить тег
git tag -l *v0.0*                                 ## поиск тегов по маске
```
