...
- [Avalonia for Visual Studio 2019,2017](https://marketplace.visualstudio.com/items?itemName=AvaloniaTeam.AvaloniaforVisualStudio)
- [Sharpen](https://marketplace.visualstudio.com/items?itemName=ironcev.sharpen)

## Visual Studio 2015 setup
- [Test Generator NUnit extension](https://marketplace.visualstudio.com/items?itemName=NUnitDevelopers.TestGeneratorNUnitextension)
