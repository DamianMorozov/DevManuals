# Dotnet MAUI resources

## Docs
- [.NET Multi-platform App UI](https://dotnet.microsoft.com/en-us/apps/maui)
- [.NET MAUI Tutorial - Build your first multi-platform app in C#](https://dotnet.microsoft.com/en-us/learn/maui/first-app-tutorial/)
- [Build your first app](https://docs.microsoft.com/en-us/dotnet/maui/get-started/first-app)
...
- [.NET MAUI code samples](https://github.com/jsuarezruiz/dotnet-maui-samples)
- [.NET MAUI - Workshop](https://github.com/dotnet-presentations/dotnet-maui-workshop)
- [maui-abp](https://gitee.com/henjiggg/maui-abp)
- [.NET MAUI Samples](https://github.com/dotnet/maui-samples)
...
- [Rachel's Recipes](https://github.com/rachelkang/recipeSearch)
