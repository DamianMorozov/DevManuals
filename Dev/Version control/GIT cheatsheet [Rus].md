...
git tag -a v0.1.2.3 -m "26.04.2018"               ## создать тег с версией и комментарием
git tag -a v0.1.2.3 0011223344                    ## создать тег с версией для коммита по части хэша
git tag -l *v1.6*                                 ## поиск тегов по маске
git tag -lw v0.1.2.3                              ## создать легковесный тег с версией
```
